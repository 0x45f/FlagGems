...
def enable(
    ...
    current_work_registrar = registrar(
        (
            ...
            ("mm", mm, Autograd.disable), # tune
            ("mm.out", mm_out, Autograd.disable), # tune
            ("sum.IntList_out", sum_dim_out, Autograd.disable), # tune
            ("contiguous", contiguous, Autograd.disable),
            ("index.Tensor", index, Autograd.disable), # tune
